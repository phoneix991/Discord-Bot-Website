...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/NA2pT5qeDw",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=1255190954319544321&permissions=8&integration_type=0&scope=applications.commands+bot",
    },
       {
      link: true,
      name: "Buy Premium",
      ...
      href: "https://www.shopier.com/ShowProductNew/products.php?id=27485893",
    },
    {
      link: true,
      name: "Partners",
