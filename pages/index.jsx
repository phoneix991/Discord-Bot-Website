...
export default function Index() {
  ...
  return (
    <>
      ...
      <img width="500" src="img/public/img/phoneixdiscord-photoaidcom-cropped (1) (1).png/" />      </div>
...
Phoneix'e Oy Ver</a>
        ...
        <Image width="600" height="600" src="/img/phoneixanasayfaarkaplansol.png"  />
        </div>
        <div style={{ zIndex: '-1' }} className="hidden xl:block undrag opacity-10 pointer-events-none -right-[15vw] absolute top-[13vw] h-[90vw] grayscale -rotate-9">
        <Image  width="600" height="600" src="/img/phoneixanasayfaarkaplansağ.png"  />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"Phoneix" }} />
            <p className="text-white text-md font-medium text-gray-500/75" dangerouslySetInnerHTML={{ __html: "Sunucunuzu en kolay ve en güzel şekilde yönetin" }}/>
            <a href="https://discord.com/oauth2/authorize?client_id=1255190954319544321&permissions=8&integration_type=0&scope=applications.commands+bot" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
              <i className="fab fa-discord mr-2" />Phoneix'i Davet Et
            </a>
          </div>
